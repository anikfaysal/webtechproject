...
<head>
	<meta charset="UTF-8">
	<title>Todays Offer Making</title>
</head>
<body width="1200">
	<table width="1200" border="1" align="center" cellpadding="0" cellspacing="0">
        ...
        <table align="left" width="100%">
            ...
            <tr height="70" align="left">
               <br/>
                <fieldset align="left">Message :Offers Made though this page will be valid for only One day</fieldset>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td width="50%" align="center">
                    <h3>
                        Offer For Today :
                        <input type="text" name="discount" placeholder="Enter Today offer rate Here....">
                    </h3>
                </td>
            </tr>
            <tr height="30">
