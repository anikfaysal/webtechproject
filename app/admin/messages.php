...
<body width="1200">
    ...
    <a href="createmessage.php">Create New Message</a>
    </fieldset>
    <br/>
        <fieldset>
                ...
                <div>
                    <table>
                        <tr>
                            ...
                            <td width="20%">
                               <button onclick="location.href='createmessage.php';">Reply</button>
                            </td>
                            <td width="20%">
                                <button onclick="location.href='deletemessage.php';">Delete</button>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="6">
