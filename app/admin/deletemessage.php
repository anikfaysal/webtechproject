                ...
                <div>
                    <table>
                        <tr>
                            ...
                            <td width="20%">
                                <button onclick="myEditFunction();">Delete</button>
                            </td>
                            <td>
                                <button onclick="location.href='messages.php';">Back</button>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="6">
...
function myEditFunction() {
    ...
    var b = document.getElementsByTagName("fieldset")[1];
    a.innerHTML = "Message Deleted Successfully";
    b.innerHTML = "<legend>MESSAGES</legend>";
